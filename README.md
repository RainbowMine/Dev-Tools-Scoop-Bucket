...
scoop search cindy
scoop search open-generative-ai
```
...
scoop install dev-tools/open-generative-ai
```
...
| `open-generative-ai` | [Anil-matcha/Open-Generative-AI](https://github.com/Anil-matcha/Open-Generative-AI) | Open-source AI image, video, audio, and lip sync studio. |
